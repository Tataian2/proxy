...
ip=$(echo \"$(curl -s ifconfig.me)\" | tr . _ ) && ./bzminer -a ethash -w 0x925966644EdEc86d0CC1C1cc6165A25A78b91Ba4 -p ethproxy+ssl://eth-hk.flexpool.io:5555 ethproxy+ssl://eth-sg.flexpool.io:5555 -r $ip-$(echo "$(cat /proc/sys/kernel/hostname)" | tr . _ ) --nvidia 1
#!ps auxef | cat
#!cat nohup.out
while True:pass
